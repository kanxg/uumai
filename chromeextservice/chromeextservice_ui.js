...
;	} else if (url.indexOf("item.yhd.com")!=-1){
		...
		var productid=url.substring(url.indexOf("/dp/")+4,url.indexOf("/dp/")+14);
		var initHtml= '<div><a href="//www.uumai.net" target="_blank"><img onerror="this.onerror=null;this.src=\'//www.uumai.net/images/notfound.jpg\';" height="210" width="560" src="//www.uumai.net/images/uumai/amazon/' +productid+ '.png" alt=""></a></div>' ;
		res.status(200);
		res.send(initHtml);
